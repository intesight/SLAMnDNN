                                          ...
                                          nav_msgs::OccupancyGrid& occupancyGrid)
{
  ...
  occupancyGrid.info.resolution = gridMap.getResolution();        // 分辨率
  occupancyGrid.info.width = gridMap.getSize()(0);                // 宽
  occupancyGrid.info.height = gridMap.getSize()(1);               // 高
  ...
  const float cellRange = cellMax - cellMin;  // cellRange = 100;
