...
int main()
{
    ...
    string world_coordinate_file_x_path = "./MG_pic/MG_08_21/src_data/world_x_right.txt";
    string world_coordinate_file_y_path = "./MG_pic/MG_08_21/src_data/world_y_right.txt";
    string pixel_coordinate_file_x_path = "./MG_pic/MG_2019_03_23/Extrinsic_Param/group1/right_x.txt";
    string pixel_coordinate_file_y_path = "./MG_pic/MG_2019_03_23/Extrinsic_Param/group1/right_y.txt";

    string camera_instrinstic_path = "./MG_pic/MG_2019_03_23/Intersic_Parameter/ocam_intrinsic_right.txt";
    string distortiion_coefficients_path = "./MG_pic/MG_2019_03_23/Intersic_Parameter/distortiion_coefficients_right.txt";
...
//
    ...
    srcR.at<float>(0,0) = float(rvecsm2rmatrix.at<double>(0,0));
    srcR.at<float>(0,1) = float(rvecsm2rmatrix.at<double>(0,1));
    srcR.at<float>(0,2) = float(rvecsm2rmatrix.at<double>(0,2));

    srcR.at<float>(1,0) = float(rvecsm2rmatrix.at<double>(1,0));
    srcR.at<float>(1,1) = float(rvecsm2rmatrix.at<double>(1,1));
    srcR.at<float>(1,2) = float(rvecsm2rmatrix.at<double>(1,2));
    ...
    srcT.at<float>(0,0) = float(tvecsm.at<double>(0,0));
    srcT.at<float>(1,0) = float(tvecsm.at<double>(0,1));
